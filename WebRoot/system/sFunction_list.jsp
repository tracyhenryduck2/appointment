	...
	<script type="text/javascript">    
		...
		function search() {  
			Dialog.open({Title:"查询", Width:650, Height:220, URL:"<%=path%>/system/SFunction!search.action",OnLoad:function(){
			     ...
			     this.innerDoc.getElementById("group_id").value = $("#group_id").val();
			     this.innerDoc.getElementById("sort_id").value = $("#sort_id").val();
           }
			});    
		}      
			...
			<table id="table1" width="100%" height="100%"  border="0" cellspacing="0" cellpadding="0"> 
			   	 <thead>
			   		<tr>  
			   			...
			   			<th sortname="group_id" width="10%">模块</th>	   
			   			<th sortname="sort_id" width="10%">排序</th>	   
			   		</tr> 
			   	</thead>
			   	<tbody> 
