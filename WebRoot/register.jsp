...
{
alert();
document.getElementById('ddda').src = 'Register!getVCode.action?'+Math.random();
}
    ...
    <div class="banner_box"> 
      <div class="login_box">
        <form action="Register!register.action" method="post" >
          ...
          <p class="bor_bot mt20"> <span class="login-ico ico2"></span>
            <input name="vcode" type="text" id="vcode" value="${vcode }" placeholder="验证码" style="width: 300px;">
          </p>
          <input class="sub mt30" type="submit" value="登录" id="login-submit">
          <img id='ddda'  src="Register!getVCode.action" onclick="shuaxin()"/>
        </form>
      </div>
    </div>
  </div>
